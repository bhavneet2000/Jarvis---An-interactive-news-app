    ...
    return (
        <Card ref={elRefs[i]} className={classNames(classes.card, activeArticle===i ? classes.activeCard : null)}>
            <CardActionArea href={url} target={"_blank"}>
                <CardMedia className={classes.media} image={urlToImage || 'https://joemiller.us/wp-content/uploads/news-636978_960_720-1.jpg'}/>
            ...
            <CardActions className={classes.cardActions}>
                <Button size="small" variant="contained" color="secondary" href={url} target={"_blank"}>Learn More</Button>
